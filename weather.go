...
func showWeatherApp()() {
	...
	combo := widget.NewSelect([]string{"Noida", "Delhi", "Varanasi", "Mumbai", "Kolkata"}, func(value string) {
		selection = value
	})
	...
	clickMe := widget.NewButton("Click To Get Weather", func() {
		resp, err := http.Get("https://api.openweathermap.org/data/2.5/weather?q=" + selection + "&appid=6dbdbd4efa7206c9ebcc7b1df9569273")
		if err != nil {
